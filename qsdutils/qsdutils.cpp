...
void QSdUtils::debugPaths(){
    ...
    qDebug() << "Packages Dir:          " << QSdUtils::packagesDir;

    qDebug() << "Plugins Dir:           " << QSdUtils::pluginsDir;
    qDebug() << "Extra QML Dir:         " << QSdUtils::extraQmlDir;
}
...
bool QSdUtils::createDefaultDirs(){
    ...
    dirs.append(QSdUtils::packagesDir);

    dirs.append(QSdUtils::pluginsDir);
    dirs.append(QSdUtils::extraQmlDir);
...
QSdUtils::QSdUtils()
{
    ...
    pluginsDir              = QString("%1/plugins").arg(QSdUtils::appRuntimeDir);
    extraQmlDir             = QString("%1/qml").arg(QSdUtils::appRuntimeDir);
...
QString QSdUtils::packagesDir           = QStandardPaths::writableLocation(QStandardPaths::CacheLocation).append("/" + appName + "/packages");

QString QSdUtils::pluginsDir            = QString("%1/plugins").arg(appRuntimeDir);
QString QSdUtils::extraQmlDir           = QString("%1/qml").arg(appRuntimeDir);
